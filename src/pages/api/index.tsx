    ...
    <article className={ `api-page ${ className }` }>
        ...
        <div id="source">
            ...
            <Alert style={{ margin: '2rem 0' }} title="Pro tip:">
                <Paragraph>An <Name /> instance, once closed, remains permanently unavailable.</Paragraph>
                <Paragraph>All operations on a closed <Name /> instance is a <code>noop</code>.</Paragraph>
                <Paragraph>When in doubt, please check its <code>closed</code> property.</Paragraph>
            </Alert>
        </div>
        <div id="consumer">
            <h3>Connection Instance</h3>
            <ListItem><div>is a consumer for an <code><Name /></code> instance.</div></ListItem>
            <ListItem><div>exposes <Anchor to="/api/method/get"><strong><code>get(...)</code></strong></Anchor>, <Anchor to="/api/method/set"><strong><code>set(...)</code></strong></Anchor> and <Anchor to="/api/method/disconnect"><strong><code>disconnect(...)</code></strong></Anchor> methods for interaction with its <Name /> instance.</div></ListItem>
            ...
            <Alert style={{ margin: '2rem 0' }} title="Pro tip:">
                <h4>Similar to the <Name /> instance</h4>
                <Paragraph>Connection, once disconnected, loses all access to its <Name /> instance permanently.</Paragraph>
                <Paragraph>To regain access, simply obtain a fresh connection from the <Name /> instance.</Paragraph>
